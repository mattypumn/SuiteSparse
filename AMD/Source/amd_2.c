...
(
    ...
    float Control [ ],	/* array of size AMD_CONTROL */
    float Info [ ]	/* array of size AMD_INFO */
)
{
 ...
 *
 * Control:  A float array of size AMD_CONTROL containing input parameters
 ...
 *
 * Info:  A float array of size AMD_INFO.  If present, (that is, not NULL),
