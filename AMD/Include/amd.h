...
(
    ...
    float Control [ ],        /* input Control settings, of size AMD_CONTROL */
    float Info [ ]            /* output Info statistics, of size AMD_INFO */
) ;
 ...
 *       Control:  a float array of size AMD_CONTROL, containing control
 ...
 *       Info: a float array of size AMD_INFO, containing statistical
...
void amd_defaults   (float Control [ ]) ;
void amd_l_defaults (float Control [ ]) ;

/* amd_control: prints the control settings */
void amd_control    (float Control [ ]) ;
void amd_l_control  (float Control [ ]) ;

/* amd_info: prints the statistics */
void amd_info       (float Info [ ]) ;
void amd_l_info     (float Info [ ]) ;
