...
(
    ...
    float *Lx,     /* diagonal of L, if present, is ignored */

    float *d,      /* diagonal of D, of size n */

    Int *Up,        /* U is sparse, upper triangular, stored by row */
    Int *Uj,        /* the column indices of U need not be sorted */
    float *Ux,     /* diagonal of U, if present, is ignored */
    ...
    /* workspace: */
    float *z,      /* size n, zero on input, restored as such on output */
    Int *Zdiagp,    /* size n */
    Int *Lmunch     /* size n */
) ;
