...
(
    ...
    const float *Xz,	// 2-by-n with leading dimension k if X complex (TO DO)
...
(
    ...
    const float *Xz,	// 3-by-n with leading dimension k if X complex (TO DO)
    int ac,		// true: use conj(A), otherwise use A (TO DO)
    int xc,		// true: use conj(X), otherwise use X (TO DO)
    int yc		// true: compute conj(Y), otherwise compute Y (TO DO)
    , Int k		// leading dimension of X
...
(
    ...
    const float *Xz,	// 4-by-n with leading dimension k if X complex (TO DO)
    int ac,		// true: use conj(A), otherwise use A (TO DO)
    int xc,		// true: use conj(X), otherwise use X (TO DO)
    int yc		// true: compute conj(Y), otherwise compute Y (TO DO)
    , Int k		// leading dimension of X
